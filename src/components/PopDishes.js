...
export default function PopDishes() {
  return (
    <div><section className="exclusive_item_part blog_item_section">
    <div className="container">
      ...
      <div className="row">
        <div className="col-sm-6 col-lg-4">
          <div className="single_blog_item">
            <div className="single_blog_img">
              <img src="img/food_item/food_item_1.png"  />
            </div>
        ...
        <div className="col-sm-6 col-lg-4">
          <div className="single_blog_item">
            <div className="single_blog_img">
              <img src="img/food_item/food_item_2.png"  />
            </div>
            <div className="single_blog_text">
              <h3>Cremy Noodles</h3>
              <p>Was brean shed moveth day yielding tree yielding day were female and </p>
        ...
        <div className="col-sm-6 col-lg-4">
          <div className="single_blog_item">
            <div className="single_blog_img">
              <img src="img/food_item/food_item_3.png"  />
            </div>
            <div className="single_blog_text">
              <h3>Honey Meat</h3>
              <p>Was brean shed moveth day yielding tree yielding day were female and </p>
